...
ALTER TABLE cart_items
    ADD CONSTRAINT uc_cart_items_items UNIQUE (items_id);
...
ALTER TABLE cart_items
    ADD CONSTRAINT fk_carite_on_cart FOREIGN KEY (cart_id) REFERENCES cart (id);

ALTER TABLE cart_items
    ADD CONSTRAINT fk_carite_on_item FOREIGN KEY (items_id) REFERENCES item (id);